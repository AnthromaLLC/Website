...
const TermsOfService = () => {
  const termsHTML = `
    ...
    <div class="legal-content">
      <strong>Last updated</strong><br><br><strong><h2>AGREEMENT TO OUR LEGAL TERMS</h2></strong><a name="_6aa3gkhykvst"></a>We are Anthroma LLC ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," "<strong>our</strong>"), a company registered in New York, United States at 418 Broadway STE N, Albany, NY 12207.<br>We operate the website <a href="http://www.anthroma.com">http://www.anthroma.com</a> (the "<strong>Site</strong>"), the mobile application USCIS Case Tracker (the "<strong>App</strong>"), as well as any other related products and services that refer or link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").<br>You can contact us by phone at 347-422-3329, email at support@anthroma.com, or by mail to 418 Broadway STE N, Albany, NY 12207, United States.<br>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("<strong>you</strong>"), and Anthroma LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.<br><br>User will receive pop up notification when entering the app<br><br>The
      ...
      AND YOU MAY HAVE ADDITIONAL RIGHTS.<br><strong><h2 id="indemnification">19. INDEMNIFICATION</h2></strong>You agree to
       defend,
      indemnify,
